...
import PurchaseRequisitionsPage from "../pages/warehouse-manager/PurchaseRequisitionsPage";
      ...
      <Route element={<ProtectedRoute />}>
        <Route element={<MainLayout />}>
          ...
          <Route element={<ProtectedRoute allowedRoles={[ROLES.MANAGER]} />}>
            ...
            />
            <Route path={ROUTES.PURCHASE_REQUISITIONS} element={<PurchaseRequisitionsPage />} />
          </Route>
